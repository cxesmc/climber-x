...
files_geo = geo_params.f90 geo_grid.f90 geo_def.f90 runoff_routing.f90 lakes.f90 fill_ocean.f90 topo_filter.f90 topo_fill.f90 \
						connect_ocn.f90 vilma1.f90 vilma2.f90 gia.f90 q_geo.f90 sed.f90 \
...
$(objdir)/geo.o : $(dir_geo)geo.f90 $(objdir)/climber_grid.o $(objdir)/control.o \
	...
	$(objdir)/q_geo.o $(objdir)/sed.o $(objdir)/vilma1.o $(objdir)/vilma2.o $(objdir)/gia.o $(objdir)/fix_runoff.o \
	$(objdir)/hires_to_lowres.o $(objdir)/hypso_topo.o $(objdir)/coast_cells.o $(objdir)/drainage_basins.o
	$(FC) $(LDFLAGS) -c -o $@ $<

$(objdir)/vilma1.o : $(dir_geo)vilma1.F90
	$(FC) $(LDFLAGS) -c -o $@ $<

$(objdir)/vilma2.o : $(dir_geo)vilma2.F90
	$(FC) $(LDFLAGS) -c -o $@ $<
...
# segfault (the i_geo=3 VILMA2 coords crash was exactly this, one level down).
