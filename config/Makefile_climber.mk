...
files_lndvc = lndvc_def.f90 lndvc_grid.f90 lndvc_decomp.f90 lndvc_downscale.f90 lndvc_aggregate.f90 lndvc_params.f90 lndvc_out.f90 lndvc_restart.f90 lndvc_model.f90
...
obj_lndvc_phys = $(objdir)/lndvc_const.o $(objdir)/lndvc_thermo.o $(objdir)/lndvc_smb_params.o \
                 ...
                 $(objdir)/lndvc_lnd_carbon_inventory.o \
...
# they recompile against a changed lndvc module; also empty under LNDVC=0 so the
# main objects do not force the framework to build.
ifeq ($(LNDVC),1)
obj_lndvc = $(patsubst %, $(objdir)/%, $(tmp_lndvc) ) $(obj_lndvc_phys)
dep_lndvc_main = $(objdir)/lndvc_model.o $(objdir)/lndvc_out.o $(objdir)/lndvc_restart.o
...
$(objdir)/climber.o : $(dir_main)climber.f90 \
	...
	$(objdir)/atm_model.o $(objdir)/ocn_model.o $(objdir)/sic_model.o $(objdir)/lnd_model.o $(dep_lndvc_main) \
...
$(objdir)/coupler.o : $(dir_main)coupler.f90 \
	...
	$(objdir)/ice_def.o $(objdir)/smb_def.o $(objdir)/bmb_def.o $(objdir)/geo_def.o $(dep_lndvc_def) $(dep_lndvc_main)
	$(FC) $(LDFLAGS) -c -o $@ $<
...
$(objdir)/lndvc_smb_grid.o : $(dir_lndvc)/smb/grid.f90 $(objdir)/precision.o
	$(FC) $(LDFLAGS) -c -o $@ $<

$(objdir)/lndvc_smb_temp.o : $(dir_lndvc)/smb/temp.f90 $(objdir)/lndvc_const.o \
						$(objdir)/lndvc_smb_params.o $(objdir)/lndvc_smb_grid.o $(objdir)/tridiag.o \
						$(objdir)/precision.o
	$(FC) $(LDFLAGS) -c -o $@ $<
...
$(objdir)/lndvc_lnd_lake_carbon_par.o : $(dir_lndvc)/lnd/lake_carbon_par.f90 $(objdir)/constants.o \
						$(objdir)/lnd_grid.o $(objdir)/lnd_params.o $(objdir)/timer.o $(objdir)/precision.o
	$(FC) $(LDFLAGS) -c -o $@ $<

$(objdir)/lndvc_lnd_lake_carbon.o : $(dir_lndvc)/lnd/lake_carbon.f90 $(objdir)/constants.o $(objdir)/control.o \
						$(objdir)/lnd_grid.o $(objdir)/lnd_params.o $(objdir)/timer.o $(objdir)/tridiag.o $(objdir)/precision.o
	$(FC) $(LDFLAGS) -c -o $@ $<
...
$(objdir)/lndvc_lnd_carbon_inventory.o : $(dir_lndvc)/lnd/carbon_inventory.f90 \
						$(objdir)/lnd_grid.o $(objdir)/precision.o
	$(FC) $(LDFLAGS) -c -o $@ $<
...
$(objdir)/lndvc_lnd_dust_emis.o : $(dir_lndvc)/lnd/dust_emis.f90 \
						$(objdir)/lnd_grid.o $(objdir)/lnd_params.o $(objdir)/precision.o
	$(FC) $(LDFLAGS) -c -o $@ $<
...
$(objdir)/lndvc_restart.o : $(dir_lndvc)/lndvc_restart.f90 $(objdir)/lndvc_def.o \
						$(objdir)/lnd_grid.o $(objdir)/climber_grid.o \
						$(objdir)/lndvc_smb_grid.o \
						$(objdir)/dim_name.o $(objdir)/precision.o
	$(FC) $(LDFLAGS) -c -o $@ $<
