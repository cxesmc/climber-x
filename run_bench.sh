...
runme -rs -q standby --omp 32 -a -o output/$outdir/DOevents/     -p ctl.year_ini=-70000 ctl.nyears=50000 ctl.iorbit=2 ctl.ice_domain_name=NH-32KM ctl.co2_const=180,190,200,210,220,230,240 ctl.flag_geo=T ctl.flag_ice=T ctl.flag_smb=T ctl.flag_bmb=T ctl.restart_in_dir=$restart_in_dir ocn.drag_topo_fac=$drag_topo_fac
