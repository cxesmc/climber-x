...
module time_step_mod
  ...
  use atm_params, only : tstep, amas, hatm, ra, cv, cle, cls, l_dust, l_diff_impl, rh_max, rskin_ocn_min, tsl_gams_min_lnd, tsl_gams_min_ice, i_tsl, c_tsl_gam, c_tsl_gam_ice, hgams
