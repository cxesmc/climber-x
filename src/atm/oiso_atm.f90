...
contains
  ...
  subroutine oiso_fract_prcw(teff, &                  ! in
    ...
    ! TODO(2026-05-28,eberhard): Decide whether to compute actual O16 content
    !                            or to leave it at 100 percent of total water.
    fro18_prcw = 100._wp*exp(1137._wp/teff**2 - 0.4156_wp/teff - 0.0020667)  ! in percent
    !fro16_prcw = 100._wp - fro18_prcw
    fro16_prcw = 100._wp  ! in percent
  ...
  subroutine oiso_fract_prcs(teff, &                  ! in
    ...
    ! TODO(2026-05-28,eberhard): Decide whether to compute actual O16 content
    !                            or to leave it at 100 percent of total water.
    fro18_prcs = 100._wp*fro18_sv*(1._wp-coef_fro18_sv_kin*teff) &
      / (1._wp+fro18_sv*(-coef_fro18_sv_kin*teff)/D18_D)  ! in percent
    !fro16_prcs = 100._wp - fro18_prcs
    fro16_prcs = 100._wp  ! in percent
  ...
  subroutine d18o_atm(o16, o18, &  ! in
    ...
    d18o = 1000.*o18/o16 / 2.0052e-3 - 1000._wp  ! permil; VSMOW mean value = 2005.20 ppm
