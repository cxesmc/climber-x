...
module atm_def
    ...
    type atm_class
      ...
      ! grid information
      integer :: lm = lm          !! number of water tracers incl. oxygen isotopes
      integer :: nm = nm          !! number of macro surface types
      integer :: i_ocn = i_ocn    !!
      integer :: i_sic = i_sic    !!
      integer :: i_lnd = i_lnd    !!
      integer :: i_ice = i_ice    !!
      ...
      real(wp), allocatable, dimension(:,:,:) :: wcon       !! atmospheric water content (kg m-2), prognostic, budget-conserving; tracers 1=bulk H2O, 2=O16, 3=O18
      ...
      ! ratio of stable oxygen isotopes O18/O16
      real(wp), allocatable, dimension(:,:) :: d18o_qam     !! deviation of O18/O16 in surface specific humidity
      real(wp), allocatable, dimension(:,:,:) :: d18o_prcw  !! deviation of O18/O16 in rainfall
      real(wp), allocatable, dimension(:,:,:) :: d18o_prcs  !! deviation of O18/O16 in snowfall
