...
!        print *,''
  ...
  subroutine ocn_nc_write(fnm,ncid,vars,ndat,nout)
    ...
    call nc_write(fnm,"hftz", sngl(vars%hftz),dims=[character(len=4) :: "latv","lev",dim_month,dim_time],start=[1,1,ndat,nout],count=[maxj,maxk,1,1],long_name="Global ocean northward heat transport",units="PW/m",missing_value=missing_value,ncid=ncid)
    call nc_write(fnm,"hfpz", sngl(vars%hfpz),dims=[character(len=4) :: "latv","lev",dim_month,dim_time],start=[1,1,ndat,nout],count=[maxj,maxk,1,1],long_name="Indo-Pacific ocean northward heat transport",units="PW/m",missing_value=missing_value,ncid=ncid)
    call nc_write(fnm,"hfaz", sngl(vars%hfaz),dims=[character(len=4) :: "latv","lev",dim_month,dim_time],start=[1,1,ndat,nout],count=[maxj,maxk,1,1],long_name="Atlantic ocean northward heat transport",units="PW/m",missing_value=missing_value,ncid=ncid)
    ...
    call nc_write(fnm,"fwtz", sngl(vars%fwtz),dims=[character(len=4) :: "latv","lev",dim_month,dim_time],start=[1,1,ndat,nout],count=[maxj,maxk,1,1],long_name="Global ocean northward freshwater transport",units="Sv/m",missing_value=missing_value,ncid=ncid)
    call nc_write(fnm,"fwpz", sngl(vars%fwpz),dims=[character(len=4) :: "latv","lev",dim_month,dim_time],start=[1,1,ndat,nout],count=[maxj,maxk,1,1],long_name="Indo-Pacific ocean northward freshwater transport",units="Sv/m",missing_value=missing_value,ncid=ncid)
    call nc_write(fnm,"fwaz", sngl(vars%fwaz),dims=[character(len=4) :: "latv","lev",dim_month,dim_time],start=[1,1,ndat,nout],count=[maxj,maxk,1,1],long_name="Atlantic ocean northward freshwater transport",units="Sv/m",missing_value=missing_value,ncid=ncid)
