...
contains
  ...
  subroutine carbon_flux_atm_lnd(f_veg, f_peat, f_ice_grd, f_shelf, f_lake,area, &
      ...
      fire_c_flux,fire_c_flux13,fire_c_flux14, & !###############fire-CO2#################################
...
!###############fire-CO2##########################################################
    real(wp), intent(in) :: fire_c_flux, fire_c_flux13, fire_c_flux14       
!#################################################################################
...
!###############fire-CO2##########################################################
    ...
    fire13_ij = fire_c_flux13 * f_veg * sec_day*day_mon * area 
    fire14_ij = fire_c_flux14 * f_veg * sec_day*day_mon * area 
