...
- **Next action is C.3** (vegetation dynamics) — confirm sub-commit shape with the user, then implement (build after each step with both `LNDVC=1` and default; small per-step commits).
